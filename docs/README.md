...
| The four live mechanisms — `noedict`, `freegate`, `wipeclear`, `swap` | [01-co-che.md](01-co-che.md) | *(pending)* |
| `mapclear` — and why carry-over entities must never be deleted | [02-mapclear.md](02-mapclear.md) | *(pending)* |
| The 4096 direction — the whole switch group, **disabled** | [03-huong-4096.md](03-huong-4096.md) | *(pending)* |
| `nonetkill` — renaming classnames in the lump, **rejected** | [04-nonetkill.md](04-nonetkill.md) | *(pending)* |
| CEF — dropped from the plan | [04-cef.md](04-cef.md) | *(pending)* |
| Measurement — logging, inventory, traps, `heartbeat`, `loadprobe` | [05-do-dac.md](05-do-dac.md) | *(pending)* |
